...
const today = new Date()
  .toLocaleString('en-EN',{weekday:'short', year:'numeric', month:'long', day:'numeric' })
</script>
...
<template>
  <div class="summary">
    ...
    ></div>
    <div class="weather">
      <div class="temp"> {{ weatherInfo?.main?.temp.toFixed(1) }} °C</div>
      <div class="weather-desc text-block">{{ toUpperCaseFirst(weatherInfo?.weather[0].description) }}</div>
    </div>
